...
namespace Royal_Shooting_range
{
    class Drawer
    {
        ...
        public Drawer()
        {
            ...
            mapIm = global::Postrelyski_Pokatyshki.Resource1.Зд;
        ...
        public void DrawGame(Graphics g, Game game)
        {
            ...
            if (!GameForm.isReset)
            {
                ...
                {
                    DrawStackedArrow(g, barrier.stackedArrow);
        ...
        private void DrawAnimation(Graphics g, Player player)
        {
            ...
            {
                case 0:
                    g.DrawImage(playerIm, 0, player.y, new Rectangle(pW * (10 - player.currFrame/8), pH * player.currAnimation, pW, pH), GraphicsUnit.Pixel);
                    break;
                case 1:
                    g.DrawImage(playerIm, 0, player.y, new Rectangle(pW * (10 - player.currFrame/8), pH * player.currAnimation, pW, pH), GraphicsUnit.Pixel);
                    break;
