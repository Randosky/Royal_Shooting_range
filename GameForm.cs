...
namespace Royal_Shooting_range
{
    public class GameForm : Form
    {
        ...
        {
            this.Icon = new Icon("C:\\Users\\bosso\\Downloads\\1_head.ico");
        ...
        public void SelectLevel()
        {
            ...
            reset.LinkClicked += (sender, args) =>
            {
                ...
                foreach (var barrier in game.barriers)
                    for (int i = 0; i < barrier.stackedArrows.Count; i++)
                        barrier.stackedArrows[i] = new Arrow(10000, 10000, 0, 0.2f);
                RemoveLevels();
                Levels = Level.CreateLevels();
                SelectLevel();
            };
